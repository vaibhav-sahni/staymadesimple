...
class Settings:
    AUTH_DATABASE_URL: str = os.getenv("AUTH_DATABASE_URL", "postgresql://postgres:pramag@localhost:5432/auth_db")
    RENTAL_DATABASE_URL: str = os.getenv("RENTAL_DATABASE_URL", "postgresql://postgres:pramag@localhost:5432/rental_db")
